...
public:
	...
	virtual CPUTEventHandledCode HandleKeyboardEvent(CPUTKey key) override;
	virtual CPUTEventHandledCode HandleMouseEvent(int x, int y, int wheel, CPUTMouseState state) override;
	virtual void HandleCallbackEvent(CPUTEventID Event, CPUTControlID ControlID, CPUTControl *pControl) override;
	...
	inline void TaskCleanUp();
	inline void UpdateGPUDepthBuf();
	inline void UpdateGPUDepthBuf(UINT idx);
