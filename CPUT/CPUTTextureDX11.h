...
public:
    ...
    CPUTTextureDX11() : mpShaderResourceView(NULL),
                        mpTexture(NULL),
                        mpTextureStaging(NULL)
    {
    }
    CPUTTextureDX11(cString &name) : mpShaderResourceView(NULL),
                                     mpTexture(NULL),
                                     mpTextureStaging(NULL),
                                     CPUTTexture(name)
    {
    }
    CPUTTextureDX11(cString &name, ID3D11Resource *pTextureResource, ID3D11ShaderResourceView *pSrv) : mpTextureStaging(NULL),
                                                                                                       CPUTTexture(name)
    {
