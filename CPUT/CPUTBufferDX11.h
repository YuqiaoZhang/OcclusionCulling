...
public:
    CPUTBufferDX11() : mpShaderResourceView(NULL),
                       mpUnorderedAccessView(NULL),
                       mpBuffer(NULL),
                       mpBufferStaging(NULL)
    {
    }
    CPUTBufferDX11(cString &name, ID3D11Buffer *pBuffer) : mpBuffer(pBuffer),
                                                           mpBufferStaging(NULL),
    ...
    CPUTBufferDX11(cString &name, ID3D11Buffer *pBuffer, ID3D11ShaderResourceView *pView) : mpBuffer(pBuffer),
                                                                                            mpBufferStaging(NULL),
    ...
    CPUTBufferDX11(cString &name, ID3D11Buffer *pBuffer, ID3D11UnorderedAccessView *pView) : mpBuffer(pBuffer),
                                                                                             mpBufferStaging(NULL),
                                                                                             mpShaderResourceView(NULL),
