...
public:
	...
	PreTestResult TransformAndPreTestAABBox(const __m128 cumulativeMatrix[4], MaskedOcclusionCulling *moc);
	static PreTestResult TransformAndPreTestAABBox_Helper(float3 bb_center, float3 bb_Half, const __m128 cumulativeMatrix[4], MaskedOcclusionCulling *moc);
