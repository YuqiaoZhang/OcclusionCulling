...
#define MAKE_ACCESSOR(name, simd_type, base_type, is_const, elements)       \
	...
	MOC_FORCE_INLINE void GatherVertices(__m256 *vtxX, __m256 *vtxY, __m256 *vtxW, const float *inVtx, const unsigned int *inTrisPtr, int numLanes, const MaskedOcclusionCullingBase::VertexLayout &vtxLayout)
	{
		assert(numLanes >= 1);
	...
	MOC_FORCE_INLINE void GatherVertices(__m256 *vtxX, __m256 *vtxY, __m256 *vtxW, const float *inVtx, const unsigned short *inTrisPtr, int numLanes, const MaskedOcclusionCullingBase::VertexLayout &vtxLayout)
	{
