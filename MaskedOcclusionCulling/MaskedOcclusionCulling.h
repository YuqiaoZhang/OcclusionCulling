...
#define _MASKED_OCCLUSION_CULLING_H_ 1
...
class MaskedOcclusionCullingBase
{
public:
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		VertexLayout() {}
		VertexLayout(int stride, int offsetY, int offsetZW) : mStride(stride), mOffsetY(offsetY), mOffsetW(offsetZW) {}
	 ...
	 */
	inline CullingResult RenderTriangles(const float *inVtx, const unsigned int *inTris, int nTris, const float *modelToClipMatrix = nullptr, BackfaceWinding bfWinding = BACKFACE_CW, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12));
	inline CullingResult RenderTriangles(const float *inVtx, const unsigned short *inTris, int nTris, const float *modelToClipMatrix = nullptr, BackfaceWinding bfWinding = BACKFACE_CW, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12));
	 ...
	 */
	inline CullingResult TestTriangles(const float *inVtx, const unsigned int *inTris, int nTris, const float *modelToClipMatrix = nullptr, BackfaceWinding bfWinding = BACKFACE_CW, ClipPlanes clipPlaneMask = CLIP_PLANE_ALL, const VertexLayout &vtxLayout = VertexLayout(16, 4, 12));
	 ...
	 */
	inline void GetAllocFreeCallback(pfnAlignedAlloc &allocCallback, pfnAlignedFree &freeCallback)
	{
		allocCallback = mAlignedAllocCallback;
		freeCallback = mAlignedFreeCallback;
	}
...
protected:
	...
	inline ~MaskedOcclusionCullingBase()
	{
	}
};
...
#include <assert.h>
#include <new>
#include "MaskedOcclusionCullingCC.inl"
#include <immintrin.h>

#if defined(__AVX512F__)
#include "MaskedOcclusionCullingAVX512.inl"
typedef MaskedOcclusionCullingAVX512::MaskedOcclusionCullingPrivate MaskedOcclusionCulling; // Use AVX512 version
#elif defined(__AVX2__)
#include "MaskedOcclusionCullingAVX2.inl"
typedef MaskedOcclusionCullingAVX2::MaskedOcclusionCullingPrivate MaskedOcclusionCulling; // Use AVX2 version
#elif defined(__AVX__)
#include "MaskedOcclusionCullingSSE.inl"
typedef MaskedOcclusionCullingSSE::MaskedOcclusionCullingSSE41::MaskedOcclusionCullingPrivate MaskedOcclusionCulling; // Use SSE4.1 version
#else
#include "MaskedOcclusionCullingSSE.inl"
typedef MaskedOcclusionCullingSSE::MaskedOcclusionCullingSSE2::MaskedOcclusionCullingPrivate MaskedOcclusionCulling; // Use SSE2 (slow) version
#endif
 ...
 */
inline MaskedOcclusionCulling *MaskedOcclusionCulling_Create(MaskedOcclusionCulling::pfnAlignedAlloc alignedAlloc, MaskedOcclusionCulling::pfnAlignedFree alignedFree)
{
	MaskedOcclusionCulling *object = nullptr;
	object = MaskedOcclusionCulling::CreateMaskedOcclusionCulling(alignedAlloc, alignedFree);
	return object;
}
 ...
 */
inline void MaskedOcclusionCulling_Destroy(MaskedOcclusionCulling *moc)
{
	MaskedOcclusionCulling::DestroyMaskedOcclusionCulling(moc);
}
