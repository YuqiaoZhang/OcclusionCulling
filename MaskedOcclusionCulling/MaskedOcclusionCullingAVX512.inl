...
#define _mmx_min_epi32 _mm_min_epi32
	...
	template <>
	MOC_FORCE_INLINE __m256 simd_cast<__m256>(float A) { return _mm256_set1_ps(A); }
	template <>
	MOC_FORCE_INLINE __m256 simd_cast<__m256>(__m256i A) { return _mm256_castsi256_ps(A); }
	template <>
	MOC_FORCE_INLINE __m256 simd_cast<__m256>(__m256 A) { return A; }
	template <>
	MOC_FORCE_INLINE __m256i simd_cast<__m256i>(int A) { return _mm256_set1_epi32(A); }
	template <>
	MOC_FORCE_INLINE __m256i simd_cast<__m256i>(__m256 A) { return _mm256_castps_si256(A); }
	template <>
	MOC_FORCE_INLINE __m256i simd_cast<__m256i>(__m256i A) { return A; }
	template <>
	MOC_FORCE_INLINE __m512 simd_cast<__m512>(float A) { return _mm512_set1_ps(A); }
	template <>
	MOC_FORCE_INLINE __m512 simd_cast<__m512>(__m512i A) { return _mm512_castsi512_ps(A); }
	template <>
	MOC_FORCE_INLINE __m512 simd_cast<__m512>(__m512 A) { return A; }
	template <>
	MOC_FORCE_INLINE __m512i simd_cast<__m512i>(int A) { return _mm512_set1_epi32(A); }
	template <>
	MOC_FORCE_INLINE __m512i simd_cast<__m512i>(__m512 A) { return _mm512_castps_si512(A); }
	template <>
	MOC_FORCE_INLINE __m512i simd_cast<__m512i>(__m512i A) { return A; }
...
#define MAKE_ACCESSOR(name, simd_type, base_type, is_const, elements)       \
	...
	MOC_FORCE_INLINE void GatherVertices(__m512 *vtxX, __m512 *vtxY, __m512 *vtxW, const float *inVtx, const unsigned int *inTrisPtr, int numLanes, const MaskedOcclusionCullingBase::VertexLayout &vtxLayout)
	{
		assert(numLanes >= 1);
	...
	MOC_FORCE_INLINE void GatherVertices(__m512 *vtxX, __m512 *vtxY, __m512 *vtxW, const float *inVtx, const unsigned short *inTrisPtr, int numLanes, const MaskedOcclusionCullingBase::VertexLayout &vtxLayout)
	{
		...
		// Fetch triangle indices.
		__m512i vtxIdx[3];
		vtxIdx[0] = _mmw_mullo_epi32(_mm512_i32gather_epi32(safeTriIdxOffset, (const int *)IndexList + 0, 4), _mmw_set1_epi32(vtxLayout.mStride));
		vtxIdx[1] = _mmw_mullo_epi32(_mm512_i32gather_epi32(safeTriIdxOffset, (const int *)IndexList + 1, 4), _mmw_set1_epi32(vtxLayout.mStride));
		vtxIdx[2] = _mmw_mullo_epi32(_mm512_i32gather_epi32(safeTriIdxOffset, (const int *)IndexList + 2, 4), _mmw_set1_epi32(vtxLayout.mStride));
	...
	MOC_FORCE_INLINE __m512 _mmw_floor_ps(__m512 x)
	{
		return _mm512_roundscale_ps(x, 1); // 1 = floor
	}

	MOC_FORCE_INLINE __m512 _mmw_ceil_ps(__m512 x)
	{
		return _mm512_roundscale_ps(x, 2); // 2 = ceil
	}

	MOC_FORCE_INLINE __m512i _mmw_cmpeq_epi32(__m512i a, __m512i b)
	{
		__mmask16 mask = _mm512_cmpeq_epi32_mask(a, b);
		return _mm512_mask_mov_epi32(_mm512_set1_epi32(0), mask, _mm512_set1_epi32(~0));
	}

	MOC_FORCE_INLINE __m512i _mmw_cmpgt_epi32(__m512i a, __m512i b)
	{
		__mmask16 mask = _mm512_cmpgt_epi32_mask(a, b);
		return _mm512_mask_mov_epi32(_mm512_set1_epi32(0), mask, _mm512_set1_epi32(~0));
	}

	MOC_FORCE_INLINE bool _mmw_testz_epi32(__m512i a, __m512i b)
	{
		__mmask16 mask = _mm512_cmpeq_epi32_mask(_mm512_and_si512(a, b), _mm512_set1_epi32(0));
		return mask == 0xFFFF;
	}

	MOC_FORCE_INLINE __m512 _mmw_cmpge_ps(__m512 a, __m512 b)
	{
	...
	MOC_FORCE_INLINE __m512 _mmw_cmpgt_ps(__m512 a, __m512 b)
	{
		__mmask16 mask = _mm512_cmp_ps_mask(a, b, _CMP_GT_OQ);
		return _mm512_castsi512_ps(_mm512_mask_mov_epi32(_mm512_set1_epi32(0), mask, _mm512_set1_epi32(~0)));
	}

	MOC_FORCE_INLINE __m512 _mmw_cmpeq_ps(__m512 a, __m512 b)
	{
		__mmask16 mask = _mm512_cmp_ps_mask(a, b, _CMP_EQ_OQ);
		return _mm512_castsi512_ps(_mm512_mask_mov_epi32(_mm512_set1_epi32(0), mask, _mm512_set1_epi32(~0)));
	}

	MOC_FORCE_INLINE __mmask16 _mmw_movemask_ps(const __m512 &a)
	{
	...
	MOC_FORCE_INLINE __m512 _mmw_blendv_ps(const __m512 &a, const __m512 &b, const __m512 &c)
	{
